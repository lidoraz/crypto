...
class S1(Strategy):
    ...
    def __init__(self, params=None):
        ...
        self.vol_ema = params.get('vol_ema', 14)
        self.vol_pct = params.get('vol_pct', 0.70)
    ...
    def add_indicators(self, df):
        ...
        df['BUY_ALGO'] = False
        df['SELL_ALGO'] = False
        df['BUY_ALGO'] = df[f'uptrend'] & df['crossed_above'] \
                         & (df['MACD_HIST'] > 0) & df['adx_up']  # | df['crossed_trend_above']
        df['SELL_ALGO'] = df[f'downtrend'] & df['crossed_below'] \
                         & (df['MACD_HIST'] < 0) & df['adx_up']  # | df['crossed_trend_below']
