...
from Analytics.binance_fetch_all_my_trades import calc_trade_pct
from Analytics.dash_utils import discrete_background_color_bins
from Analytics.show_orders import get_table
from Analytics.show_orders import update_orders_table
...
def update_table_view(page_current, page_size, sort_by, filter_string):
    ...
    filtered = dff.iloc[page_current * page_size:(page_current + 1) * page_size].to_dict('records')
    return wrapped_text, filtered
